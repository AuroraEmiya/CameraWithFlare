...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "v2.0.0rc10"
  WORKING_DIRECTORY "/home/sakura/DoubleLens/build/_deps/tinyobjloader-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/sakura/DoubleLens/build/_deps/tinyobjloader-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/sakura/DoubleLens/build/_deps/tinyobjloader-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
